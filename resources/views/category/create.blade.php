...
<div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Enter your text" name="meta_title">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-password">Description</label>
                                            <input type="text" id="example" class="form-control" name="meta_description">
                                        </div>
                                       
                                        <div class="form-group">         
                                        <label for="img">Select image:</label>
                                          <input type="file" id="image" name="meta_image" >
                                          </div>
